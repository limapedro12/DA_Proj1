...
public:
    ...
    /**
     * @param n maximum number of simultaneous arrivals before removing segments
     */
    void setMaxBefore(int n);
    /**
     * @return difference between maximum number of simultaneous arrivals before and after removing segments
     */
    int getMaxDiff() const;
    /**
     * @param n difference between maximum number of simultaneous arrivals before and after removing segments
     */
